...
import ProfileDropdown from "../Auth/Profile-dropdown/Profiledropdown";
    ...
    return (
        <div>
            ...
            <Navbar expand="lg" bg="transparent" variant="light" className="navbar-custom border-bottom">
                <Container fluid className="mx-5 p-1  nav-container">
                    {/* Left Section - Logo */}
                    <Link to={"/"} className="text-decoration-none">  <Navbar.Brand className=""><img src="https://static.startuptalky.com/2021/06/Nykaa-logo-StartupTalky.jpg" height={45} width={85} className="m-0 p-0"></img></Navbar.Brand></Link>

                    {/* Middle Section - Navigation Links (Visible on Large Screens) */}
                    <div className="d-none d-lg-flex flex-grow-1 justify-content-start align-items-center">
                        <Nav>
                            <Nav.Item>
